...
import { LayoutDashboard, Upload, FileSpreadsheet, Table2, Users, Wallet, Printer, CreditCard } from 'lucide-react';
  ...
  <aside className="sidebar">
    ...
    <nav>
      <ul className="nav-links">
        ...
        <li>
          <NavLink to="/credit-sales" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
            <CreditCard size={20} /> Credit Sales
          </NavLink>
        </li>
        <li>
